...
export const SAFE_ENV_VARS = new Set([
  ...
  'DISABLE_TELEMETRY',
  'ENABLE_TOOL_SEARCH',
  // The Gemini Vertex / Google Cloud project-id vars are deliberately NOT
  // listed here — a project id from untrusted settings would switch Vertex
  // traffic to an attacker-controlled project (same policy as the Anthropic
  // Vertex project id, which is managed but not safe).
  'GEMINI_VERTEX_AUTH_MODE',
  'GEMINI_VERTEX_LOCATION',
